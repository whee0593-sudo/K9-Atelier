  ...
  return (
    ...
    >
      ...
      <div className="k9-gallery-track">
        ...
        <CredentialsSection onOpen={openIfClick} />
...
function DragHint({ visible }: { visible: boolean }) {
  return (
    <p
      ...
      className={`k9-gallery-hint font-body text-[10px] uppercase tracking-[0.32em] text-[#e8dcc6]/55 ${visible ? "k9-gallery-hint-visible" : ""}`}
    >
      Drag to explore&nbsp;&nbsp;→
    </p>
  );
