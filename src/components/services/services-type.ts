/**
 * Shared type scale for the /services landing page.
...
export const servicesSupportClass =
  "font-body text-[15px] leading-[1.7] text-taupe";

export const servicesPriceClass =
