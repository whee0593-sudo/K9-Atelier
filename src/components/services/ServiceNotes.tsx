    ...
    <section className="border-t border-gray-line/70 bg-ivory">
      <Container className="py-14 md:py-16">
        <div className="mx-auto max-w-md text-center">
          ...
          <div className="font-body mt-5 space-y-3 text-sm leading-relaxed text-taupe">
            <p>
          ...
          <Link
            ...
            className="font-body mt-8 inline-flex min-h-[48px] items-center justify-center text-[11px] font-medium uppercase tracking-[0.16em] text-ink transition hover:text-deep-lavender focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-champagne"
          >
            View Fees &amp; Policies
