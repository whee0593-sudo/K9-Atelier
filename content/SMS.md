...
客人发到店号的**图片**会尽量转到你的手机。店号需要开通 **MMS**。若彩信发不出去，你会先收到文字说明。iPhone 请用短信/彩信发送，不要走 iMessage。

你在私人手机上回复那条转发短信，会从店号发给最近一位客人。客人看到的是店号。

店号来电如果没接起来，会自动给客人发短信（不用你在后台点发送；同一号码 24 小时内不重复发）：

- **陌生号码** — 系统里保存的那一版：预约页、留言页，并请对方回复宠物资料
- **已有档案的客人** — 新版本：称呼名字、预约链接，请对方直接回复，不再要品种/体重等资料

你接听了就不会发这条“暂时无法接听”的短信。来电会出现在 **Customer Messages → Recent callers**。需要补发时可以再点 **Send text**，也可以手输号码发送。
